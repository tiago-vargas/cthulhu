...
- **P.3: Qual instinto você vai seguir?**
	...
	- **>> Esquerda**
		...
		- Nyarlathotep tenta mais um golpe, mas você sente uma onda de vento, e ao olhar para trás, percebe uma silhueta misteriosa te protegendo do ataque. 
		
		- ???: Vá em frente, Jesse. Eu cuido do Nyarlathotep."
		
		- Ny: COMO OUSAS ATRAPALHAR MEU PLANO, SEU TRAIDOR?"
		
		- De repente, você é jogada para frente, contra a parede da passagem por uma onda de vento.
	...
	- **>> Direita**
		...
		- Ny: Eu não obedeço a ninguém, ainda a mais um traidor como você.
		...
		- Quando você está entrando pela passagem, os tentáculos ainda em chamas te dão um último golpe de oportunidade em suas costas, que te arremessa para frente. 
...
- **>> L:** 
	 ...
	 - **>>E - Esquerda** 			
		...
		- A criatura vai em direção a você, preparando para dar um golpe final, até que surge uma silhueta misteriosa que defende o golpe.
		
		- ??????: O que você está fazendo aqui, seu traidor?
		
		- ???: Apenas o correto a se fazer, Nyarlathotep.")
		
		- Ny: Já não basta ser um traídor, agora tem que atrapalhar os meus planos.
...
- **>>Sim:**
	...
	- Nyarlathotep: Se você tiver o mínimo de massa cerebral você não faria isso, pois ao invés de destruir todo o mundo, eu te dou um pedaço dele para governar e ser uma deusa entre esses humanos nojentos.’
...
Alice: E o Hastur está logo ali.
...
Jesse: Mas… Ele não falou o que temos que fazer agora.
